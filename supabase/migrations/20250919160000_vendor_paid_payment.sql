-- vendor_paid: sale at counter → delivered; PIX and pay-on-delivery → pending.

ALTER TYPE payment_method ADD VALUE IF NOT EXISTS 'vendor_paid';
...
BEGIN
  ...
  v_item_status := CASE
    WHEN p_forma_pagamento = 'vendor_paid' THEN 'delivered'::delivery_status
